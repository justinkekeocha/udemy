...
import { camel, debounce } from 'radash';
            ...
            <template v-for="row in coursesTab">
              <li class="mr-2" role="presentation">
                <button
                  ...
                  :data-tabs-target="'#' + camel(row.title)" type="button" role="tab" aria-selected="false">{{ row.title
                  }}</button>
              </li>
            </template>
          </ul>
                  ...
                  <div class="grid grid-cols-12 gap-7">
                    <div class="col-span-12 md:col-span-5">
                      <div class="bg-zinc-900">
                        <img
                          class="w-full h-auto object-center object-cover align-middle group-hover:opacity-80 transition-opacity"
                          :src="row.image">
                      </div>
                    </div>
                    <div class="col-span-12 md:col-span-7">
                      <div class="grid grid-cols-1 content-between max-w-lg">
                        <div class="flex flex-col gap-1">
                          ...
                          <p class="text-xs">
                            <span class="text-teal-800">Updated <b class="font-UdemySansBold">June
                                2023</b></span>
        ...
        <div class="p-1">
          ...
          <Slide class="grid-rows-2 !gap-2">
            <template v-for="(row, index) in topics" :key="row.id">
              <div class="snap-start border border-gray-300 hover:bg-slate-50 transition-opacity py-4 px-20 text-center">
      ...
      <section class="mb-10">
        ...
        <div class="flex border border-gray-300 p-3 items-center mb-8">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="w-10 h-10 fill-zinc-900 text-white me-2">
        ...
        <div class="container mx-auto">
          <div class="grid grid-cols-4 gap-6">
            ...
            <div :class="[showSideMenu ? 'col-span-1' : 'hidden']">

            </div>
            <div :class="[showSideMenu ? 'col-span-3' : 'col-span-4']">2
              {{ showSideMenu }}
            </div>
          </div>
        </div>
