...
<template>
  <nav
    class="flex flex-row flex-wrap gap-x-5 p-1 bg-white border-gray-200 dark:bg-gray-900 shadow-md items-center"
  >
      ...
      <Popover target="categories" class="z-50">
        ...
        >
          <template v-for="row in categoryStore.categories">
            ...
            >
              <Link
                :href="route('category.show', [{ name: row.name }])"
